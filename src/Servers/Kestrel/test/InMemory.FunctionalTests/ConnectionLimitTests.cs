...
public class ConnectionLimitTests : LoggedTest
{
    ...
    public async Task RejectsConnectionsWhenLimitReached()
    {
        ...
        using var rejectedConnections = new InstrumentRecorder<long>(new TestMeterRegistry(testMeterFactory.Meters), "Microsoft.AspNetCore.Server.Kestrel", "kestrel-rejected-connections");
