...
public class KestrelMetricsTests : TestApplicationErrorLoggerLoggedTest
{
    ...
    public async Task Http1Connection()
    {
        ...
        using var queuedConnections = new InstrumentRecorder<long>(new TestMeterRegistry(testMeterFactory.Meters), "Microsoft.AspNetCore.Server.Kestrel", "kestrel-queued-connections");
    ...
    public async Task Http2Connection()
    {
        ...
        using var currentConnections = new InstrumentRecorder<long>(new TestMeterRegistry(testMeterFactory.Meters), "Microsoft.AspNetCore.Server.Kestrel", "kestrel-current-connections");
        using var queuedConnections = new InstrumentRecorder<long>(new TestMeterRegistry(testMeterFactory.Meters), "Microsoft.AspNetCore.Server.Kestrel", "kestrel-queued-connections");
        using var queuedRequests = new InstrumentRecorder<long>(new TestMeterRegistry(testMeterFactory.Meters), "Microsoft.AspNetCore.Server.Kestrel", "kestrel-queued-requests");
        using var tlsHandshakeDuration = new InstrumentRecorder<double>(new TestMeterRegistry(testMeterFactory.Meters), "Microsoft.AspNetCore.Server.Kestrel", "kestrel-tls-handshake-duration");
        using var currentTlsHandshakes = new InstrumentRecorder<long>(new TestMeterRegistry(testMeterFactory.Meters), "Microsoft.AspNetCore.Server.Kestrel", "kestrel-current-tls-handshakes");
